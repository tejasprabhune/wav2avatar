...
function createTarget(json_data, i) {
    return {
        tty: 3 * json_data["tt"][0][i] - 5, ttz: 3 * json_data["tt"][1][i] + 10,
        tby: 3 * json_data["tb"][0][i] + 3, tbz: 3 * json_data["tb"][1][i] + 5,
        tdy: 3 * json_data["td"][0][i] - 5, tdz: 3 * json_data["td"][1][i] - 0,
        ...
        tongue_basey: json_data["li"][0][i] - 20, tongue_basez: 0.6 * json_data["li"][1][i] + 3,
...
function getParts(object) {
    return {
        ...
        tongue_base: object.children[11],
        head_li: object.children[5],
        ul: object.children[6],
        ll: object.children[7],
        head_li_base: object.children[8],
        li: object.children[9],
        tb: object.children[12],
        td: object.children[13],
        tt: object.children[14]
    }
}
...
function setupAvatar(object) {
  ...
  pinkMaterial.color = new THREE.Color('pink');
  ...
  // Face Fragment Color
  object.children[1].children[0].material = faceMaterial;
  object.children[1].children[0].material[1] = faceMaterial;

  // Face Full Color
  console.log(object.children[4].children[1])
   object.children[4].children[1].material = faceMaterial;
  ...
  object.children[4].children[0].material = whiteMaterial;

  object.children[0].material = whiteMaterial;

  // Tongue
  object.children[10].material = pinkMaterial;
...
loader.load( '/static/roger_avatarv4.fbx', (object) => {
  setupAvatar(object);
  //animate();
  afterLoad(object);
  renderer.render(scene, camera);
